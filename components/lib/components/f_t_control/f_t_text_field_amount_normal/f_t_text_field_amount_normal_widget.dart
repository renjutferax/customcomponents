...
import 'f_t_text_field_amount_normal_model.dart';
export 'f_t_text_field_amount_normal_model.dart';

class FTTextFieldAmountNormalWidget extends StatefulWidget {
  const FTTextFieldAmountNormalWidget({
    super.key,
    this.hintText,
    this.tooltipText,
    this.labelText,
  ...
  State<FTTextFieldAmountNormalWidget> createState() =>
      _FTTextFieldAmountNormalWidgetState();
}

class _FTTextFieldAmountNormalWidgetState
    extends State<FTTextFieldAmountNormalWidget> {
  late FTTextFieldAmountNormalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FTTextFieldAmountNormalModel());
